...
const Slider = () => {
  ...
  return (
    <Carousel autoPlay showThumbs={false} interval={6000} showStatus={false} infiniteLoop={true} className="carousel-description absolute left-auto right-auto bottom-1/3 mb-10 text-left w-full lg:container px-4 md:px-10">
        ...
        return (
          <div key={item.name} className='carousel-slide'>
            <div className="carousel-description absolute left-auto right-auto bottom-1/3 mb-10 text-left w-full lg:container px-4 md:px-10">
              ...
              <a className="btn btn-sm lg:btn-md mt-3" href={`/${item.name}`}>
                바로가기
